...
?>
  ...
  <i class="fa fa-plus"></i> <b>Add New Student</b>
   ...
   <a href="logout.php" class="btn btn-danger" style="margin-left: 880px;"><i class="fa fa-lock"></i> Logout</a>
  <hr>
        ...
        <div>
       <form method="post" action="download.php" style="margin-left: 500px;" style="margin-top: 100px;" >
     <input type="submit" name="download" class="btn btn-success"  value="Download Data">
...
while ($row = mysqli_fetch_array($run_data)) {
    ...
    echo " <div class='modal fade' id='view$id' tabindex='-1' role='dialog' aria-labelledby='userViewModalLabel' aria-hidden='true'>
    <div class='modal-dialog'>
    <div class='modal-content'>
    <div class='modal-header'>

    <h2 class= 'modal-title' id='exampleModalLabelledby'>Profile
    <i class='fa fa-user-circle-o' aria-hidden='true'></i></h2>
    ...
    <div class='card-body'><p> $family </p>
    </div>
    </div>
...
while($row = mysqli_fetch_array($run_data)){
    ...
    echo "<div id='edit$id' class='modal fade' role='dialog'>
    ...
    <div class='form-group col-md-6'>
    <lable>Student</label>
    <input type='text' class='form-control' name='card_no' placeholder='Enter ID' value='$card' required>  
    </div>

    <div class='form-group col-md-6'>
    <label> mobile No.</label>
    <input type = 'phone' class='form-control' name='user_phone' placeholder='Enter phon no.' value='$phone' required> 
    </div>
    </div>
...
<div class='form-group col-md-6'>
<label for='aadharno'>Aadhar No.</label>
<input type='text' class='form-control' name='user_aadhar' maxlength='12' placeholder='Enter 12-digit Aadhar no. value='$aadhar' required>
</div>
</div>
...
<div class='form-group'>
<label for='inputAddress'>Village</label>
<input type='text' class='form-control' name='village' placeholder='Address' value='$village'>
</div>
...
while ($row = mysqli_fetch_array($run_data)) {
    ...
    <h4 class='modal-title text-center'> Are you sure you want delete your student profile ? </4>
